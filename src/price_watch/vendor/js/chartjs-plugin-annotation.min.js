...
!(function (t, e) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        : "function" == typeof define && define.amd
          ...
          : ((t = "undefined" != typeof globalThis ? globalThis : t || self)["chartjs-plugin-annotation"] = e(
                t.Chart,
                t.Chart.helpers
            ));
})(this, function (t, e) {
    ...
    const x = (t) => "string" == typeof t && t.endsWith("%"),
        ...
        g = {
            ...
            doughnutLabel: (t) => b(t.centerX, t.centerY),
            ellipse: (t) => ({ centerX: t.centerX, centerY: t.centerX, radius: 0, width: 0, height: 0 }),
            label: (t) => b(t.centerX, t.centerY),
            line: (t) => b(t.x, t.y),
            point: (t) => ({ centerX: t.centerX, centerY: t.centerY, radius: 0, width: 0, height: 0 }),
    ...
    function W(t, o, n) {
        ...
        ((t.fillStyle = n.backgroundColor),
            ...
            e.addRoundedRectPath(t, {
                ...
                w: s,
                h: a,
                radius: c(e.toTRBLCorners(n.borderRadius), 0, Math.min(s, a) / 2),
            }),
            t.closePath(),
            t.fill(),
            d && ((t.shadowColor = n.borderShadowColor), t.stroke()),
            t.restore());
    }
    function z(t, o, n, i) {
        const r = n.content;
            ...
            (function (t, { x: o, y: n, radius: i, rotation: r, style: s, rad: a }) {
                ...
                switch ((t.beginPath(), s)) {
                    default:
                        ...
                        break;
                    case "triangle":
                        (t.moveTo(o + Math.sin(a) * i, n - Math.cos(a) * i),
                            (a += e.TWO_THIRDS_PI),
                            t.lineTo(o + Math.sin(a) * i, n - Math.cos(a) * i),
                            (a += e.TWO_THIRDS_PI),
                            t.lineTo(o + Math.sin(a) * i, n - Math.cos(a) * i),
                            t.closePath());
                        break;
                    case "rectRounded":
                        ((h = 0.516 * i),
                            (c = i - h),
                            (d = Math.cos(a + e.QUARTER_PI) * c),
                            (l = Math.sin(a + e.QUARTER_PI) * c),
                            t.arc(o - d, n - l, h, a - e.PI, a - e.HALF_PI),
                            t.arc(o + l, n - d, h, a - e.HALF_PI, a),
                            t.arc(o + d, n + l, h, a, a + e.HALF_PI),
                            t.arc(o - l, n + d, h, a + e.HALF_PI, a + e.PI),
                            t.closePath());
                        break;
                    case "rect":
                        if (!r) {
    ...
    function N(t, o) {
        ...
        const { separatorStart: l, separatorEnd: c } = (function (t, e) {
                ...
                let a, d;
                "left" === e || "right" === e
                    ? ((a = { x: o + s, y: n }), (d = { x: a.x, y: r }))
                    : ((a = { x: o, y: n + s }), (d = { x: i, y: a.y }));
            ...
            { sideStart: h, sideEnd: u } = (function (t, e, o) {
                ...
                let l, c;
                "left" === e || "right" === e
                    ? ((l = { x: o.x, y: n + v(r, a) }), (c = { x: l.x + d, y: l.y }))
                    : ((l = { x: o.x + v(i, a), y: o.y }), (c = { x: l.x, y: l.y + d }));
                return { sideStart: l, sideEnd: c };
            })(o, d, l);
        ((a.margin > 0 || 0 === s.borderWidth) && (t.moveTo(l.x, l.y), t.lineTo(c.x, c.y)),
            t.moveTo(h.x, h.y),
            t.lineTo(u.x, u.y));
    ...
    function U(t, e) {
        ...
        let s = o.width / 2,
            a = o.height / 2;
        return (
            i && (s = V(i, e.xValue, i.left + i.width / 2)),
            r && (a = V(r, e.yValue, r.top + r.height / 2)),
            { x: s, y: a }
        );
    }
    function J(t, e) {
    ...
    function tt(t, o, n) {
        ...
        const r = M(i.position),
            ...
            d = (function ({ properties: t, options: e }, o, n, i) {
                ...
                return Z(
                    { start: r, end: s, size: a, borderWidth: e.borderWidth },
                    {
                        position: n.x,
                        padding: { start: i.left, end: i.right },
            ...
            l = (function ({ properties: t, options: e }, o, n, i) {
                ...
                return Z(
                    ...
                    {
                        position: n.y,
                        padding: { start: i.top, end: i.bottom },
    ...
    function dt(t, o, n) {
        const i = (function (t, o, n) {
            ...
            for (const e of n)
                e.scaleID === r
                    ? ut(e, o, ["value", "endValue"], a)
                    : B(t, e, s) === r && ut(e, o, [i + "Min", i + "Max", i + "Value"], a);
            return a;
        })(t.scales, o, n);
        let r = lt(o, i, "min", "suggestedMin");
        ((r = lt(o, i, "max", "suggestedMax") || r),
            r && e.isFunction(o.handleTickRangeOptions) && o.handleTickRangeOptions());
    }
    function lt(t, o, n, i) {
        if (
            e.isFinite(o[n]) &&
    ...
    class ft extends t.Element {
        ...
        draw(t) {
            (t.save(),
                Y(t, this.getCenterPoint(), this.options.rotation),
                W(t, this, this.options),
                t.restore());
        }
        get label() {
        ...
        resolveElementProperties(o, n) {
                        ...
                        return r instanceof t.DoughnutController &&
                            (function (t, e, o) {
                                ...
                                for (let e = 0; e < o.length; e++)
                                    if (!o[e].hidden && t.getDataVisibility(e)) return !0;
                            })(e, o, i.data) &&
            ...
            const {
                ...
                const { left: i, top: r, right: s, bottom: a } = t,
                    ...
                    f = {
                        left: Math.max(h - d, i),
                        right: Math.min(h + d, s),
                        top: Math.max(u - d, r),
                        bottom: Math.min(u + d, a),
                    },
                    ...
                    g = (function (t, o, n, i) {
                        ...
                        const c = (-a - Math.sqrt(l)) / 2,
                            h = (-a + Math.sqrt(l)) / 2;
                        return {
                            _startAngle: e.getAngleFromPoint({ x: o, y: n }, { x: c, y: t }).angle,
                            _endAngle: e.getAngleFromPoint({ x: o, y: n }, { x: h, y: t }).angle,
                        };
                    })(b ? r + y : a - y, h, u, p),
                ...
                return {
                    controllerMeta: m,
                    point: x,
                    radius: Math.min(d, Math.min(f.right - f.left, f.bottom - f.top) / 2),
                };
            })(o, n, i);
            let d = E(o.ctx, n);
                ...
                z(
                    ...
                    (function ({ x: t, y: o, width: n, height: i, options: r }) {
                        ...
                        return {
                            x: t + a.left + s,
                            y: o + a.top + s,
                            width: n - a.left - a.right - r.borderWidth,
                            height: i - a.top - a.bottom - r.borderWidth,
                        };
                    })(this),
                    o
                ),
    ...
    const pt = (t, e, o) => ({ x: t.x + o * (e.x - t.x), y: t.y + o * (e.y - t.y) }),
        ...
        mt = (t) => t * t,
        vt = (t, e, { x: o, y: n, x2: i, y2: r }, s) =>
            "y" === s
                ? { start: Math.min(n, r), end: Math.max(n, r), value: e }
                : { start: Math.min(o, i), end: Math.max(o, i), value: t },
    ...
    class Ct extends t.Element {
                ...
                return (
                    (function (t, o, n, i) {
                        ...
                        (t.beginPath(),
                            ...
                            (o.path = v),
                            (o.ctx = t),
                            Yt(t, g, { angle: p, adjust: u }, c),
                            Yt(t, m, { angle: b, adjust: f }, h));
                    })(t, this, s, d),
                    t.restore()
                );
        ...
        resolveElementProperties(t, o) {
                    ...
                    const { width: r, height: s, padding: a } = n,
                        ...
                        f = (function (t, e, o) {
                            const n = Math.cos(o),
                                i = Math.sin(o);
                            return {
                                w: Math.abs(t * n) + Math.abs(e * i),
                                h: Math.abs(t * i) + Math.abs(e * n),
                            };
                        })(r, s, u),
                        x = (function (t, e, o, n) {
                            let i;
                            ...
                            i =
                                "start" === e.position
                                    ? Dt({ w: t.x2 - t.x, h: t.y2 - t.y }, o, e, r)
                                    : "end" === e.position
                                      ? 1 - Dt({ w: t.x - t.x2, h: t.y - t.y2 }, o, e, r)
                                      : m(1, e.position);
                            return i;
            ...
            return (
                (h._visible = l),
                (c.elements = [
                    { type: "label", optionScope: "label", properties: h, initProperties: c.initProperties },
                ]),
                c
            );
        }
    ...
    function At({ x: t, y: e }, o, { top: n, right: i, bottom: r, left: s }) {
        return (
            t < s && ((e = gt(s, { x: t, y: e }, o)), (t = s)),
            t > i && ((e = gt(i, { x: t, y: e }, o)), (t = i)),
            e < n && ((t = bt(n, { x: t, y: e }, o)), (e = n)),
            e > r && ((t = bt(r, { x: t, y: e }, o)), (e = r)),
            { x: t, y: e }
        );
    }
    ...
    function jt(t, e) {
        ...
        return o > i - n
            ? (i + n) / 2
            : (n >= t - r - s && (t = n + r + s), i <= t + r + s && (t = i - r - s), t);
    }
    function Ot(t) {
        const e = t.options,
    ...
    ((Ct.defaults = {
        ...
        arrowHeads: {
            display: !1,
            end: Object.assign({}, kt),
            fill: !1,
            length: 12,
            start: Object.assign({}, kt),
            width: 6,
        },
        borderDash: [],
        borderDashOffset: 0,
        ...
        label: {
            ...
            borderShadowColor: "transparent",
            borderWidth: 0,
            callout: Object.assign({}, yt.defaults.callout),
            color: "#fff",
            content: null,
            display: !1,
            drawTime: void 0,
        ...
        (Ct.descriptors = {
            arrowHeads: { start: { _fallback: !0 }, end: { _fallback: !0 }, _fallback: !0 },
        }),
    ...
    class Xt extends t.Element {
        ...
        draw(t) {
            ...
            (t.save(),
                Y(t, this.getCenterPoint(), s.rotation),
                _(t, this.options),
                t.beginPath(),
                (t.fillStyle = s.backgroundColor));
            const a = X(t, s);
            (t.ellipse(i, r, n / 2, o / 2, e.PI / 2, 0, 2 * e.PI),
                t.fill(),
    ...
    ((Xt.id = "ellipseAnnotation"),
        (Xt.defaults = {
            ...
            hitTolerance: 0,
            init: void 0,
            label: Object.assign({}, ft.defaults.label),
            rotation: 0,
            shadowBlur: 0,
            shadowOffsetX: 0,
            shadowOffsetY: 0,
        ...
        (Xt.defaultRoutes = { borderColor: "color", backgroundColor: "color" }),
        (Xt.descriptors = { label: { _fallback: !0 } }));
    class _t extends t.Element {
        inRange(t, e, o, n) {
            ...
            if ("x" !== o && "y" !== o)
                return (function (t, e, o, n) {
                    return (
                        !(!t || !e || o <= 0) &&
                        Math.pow(t.x - e.x, 2) + Math.pow(t.y - e.y, 2) <= Math.pow(o + n, 2)
                    );
        ...
        draw(t) {
            ...
            const n = X(t, e);
            (F(t, this, this.centerX, this.centerY),
                n && !I(e.pointStyle) && ((t.shadowColor = e.borderShadowColor), t.stroke()),
                t.restore(),
                (e.borderWidth = o));
        }
        resolveElementProperties(t, e) {
    ...
    ((_t.id = "pointAnnotation"),
        ...
        (_t.defaultRoutes = { borderColor: "color", backgroundColor: "color" }));
                ...
                return (
                    ...
                    (function (t, e, o, n) {
                        ...
                        for (const s of t) {
                            ...
                            (t.bY > o != r.bY > o &&
                                e < ((r.bX - t.bX) * (o - t.bY)) / (r.bY - t.bY) + t.bX &&
                                (i = !i),
                                (r = t));
                        }
                        return i;
    ...
    function Bt(o, n, i, r) {
        ...
        for (let t = 0; t < a.length; t++) {
            ...
            ((l.skip = $t(l)),
                "elements" in l && (Ut(i, l.elements, r, s), delete l.elements),
                e.defined(i.x) || Object.assign(i, l),
                Object.assign(i, l.initProperties),
                (l.options = qt(r)),
                s.update(i, l));
        }
    }
    ...
    function qt(t) {
        ...
        ((o.id = t.id),
            ...
            Object.assign(o, Qt(t, e.defaults), Qt(t, e.defaultRoutes)));
    ...
    var ee = {
        ...
        descriptors: {
            _indexable: !1,
            _scriptable: (t) => !te.includes(t) && "init" !== t,
            annotations: { _allKeys: !1, _fallback: (t, e) => `elements.${zt[Vt(e.type)].id}` },
            interaction: { _fallback: !0 },
            common: { label: { _indexable: Lt, _fallback: !0 }, _indexable: Lt },
        },
            ...
            for (const n of t)
                if (
                    ...
                    for (const t of n.elements)
                        t.options.display && t.options.drawTime === e && o.push({ element: t });
            return o;
